    ...
    return (
      <div className="px-6">
        ...
        <div className="pt-4 flex flex-col gap-2 overflow-hidden">
          ...
          >
            <div
              className={classNames(
                "p-4 flex flex-col gap-2 relative bg-grey-800 border-grey-600 border-[0.5px] rounded-lg w-full",
                {
          ...
          <div className="p-4 flex flex-col gap-2 relative -z-10 bg-grey-800 border-grey-600 border-[0.5px] rounded-lg">
            <p className="text-sm font-normal">
              The best way to secure your assets is to use a hardware wallet
            </p>
            <div className="flex justify-between items-center">
      ...
      <>
        <div className="px-4 w-full flex flex-col gap-4">
          ...
          >
            <div
              className={classNames(
                "p-4 flex bg-grey-800 rounded-md justify-between w-full",
                {
            ...
            >
              <div className="flex flex-col gap-4 max-w-[210px] w-full justify-between">
                ...
                <div className="flex items-center gap-1 justify-between">
                  ...
                  <div className="px-4 py-2 bg-grey-0 flex items-center justify-center rounded-3xl">
                    <p className="text-xs text-grey-950 font-bold">
                      10,000 BONK
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-1 justify-between">
                ...
                <div className="px-4 py-2 bg-grey-0 flex items-center justify-center rounded-3xl">
                  <p className="text-xs text-grey-950 font-bold">10,000 BONK</p>
                </div>
              </div>
