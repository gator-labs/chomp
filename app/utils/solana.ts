...
import { createBurnCheckedInstruction, getAssociatedTokenAddress, createTransferCheckedInstruction } from "@solana/spl-token";
...
export const genBonkTransferTx = async (recipientAddress: string, blockhash: string) => {
  const bonkPublic = new PublicKey(BONK_PUBLIC_ADDRESS);
