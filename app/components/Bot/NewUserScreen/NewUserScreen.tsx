  ...
  return (
    <div className="space-y-6 flex flex-col w-3/3 p-4 items-center justify-center">
      <Image
        ...
        className="mt-5"
      />
      <p className="text-[1.6rem] font-bold text-center">Wallet Created</p>
      <p className="flex flex-col space-y-4 text-left">
        <span className="block">
          Congratulations on creating your Chomp wallet!
        </span>
        <span className="block">
          Now proceed with playing, load up some{" "}
          <strong className="font-bold">SOL</strong> or{" "}
          <strong className="font-bold">BONK</strong> in your wallet first.
        </span>
        <span className="block">
