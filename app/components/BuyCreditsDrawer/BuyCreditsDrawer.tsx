      ...
      >
        <DrawerContent className="p-6 flex flex-col gap-2">
          ...
          <p>
            ...
            You&apos;ll get your Credits back for giving the best answer for the
            first order question, and up to an additional BONK per question
            depending on the accuracy of your second order response.
            <br />
            <br />
