    ...
    return (
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="flex flex-col gap-4 w-full">
          <Button
            variant="grayish"
            className="items-center gap-1 h-[50px] !bg-grey-400 !text-grey-600 cursor-auto"
            disabled
          >
      ...
      <div className="flex flex-col gap-4 items-center justify-center">
        ...
        <div className="flex flex-col gap-4 w-full">
          <Button
            disabled
            className={classNames(
              "!bg-grey-400 text-[13px] font-semibold leading-[16.38px] text-left flex items-center justify-center border-none",
              className,
            )}
          >
            <span className="text-grey-600">Claimed</span>
  ...
  return (
    <div className="flex flex-col gap-4 items-center justify-center">
      ...
      <div className="flex flex-col gap-4 w-full">
        ...
        >
          <span className="text-grey-600">Unclaimable</span>
          <DollarIcon height={24} width={24} fill="#666666" />
        </Button>
      </div>
    </div>
