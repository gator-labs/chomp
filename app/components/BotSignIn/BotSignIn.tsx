...
//   }, []);
  ...
  return (
    <div className="space-y-6 flex flex-col w-3/3 mt-12 p-4 items-center justify-center">
      <Image src="/images/chomp-asset.png" width={400} height={400} alt="Chomp Cover" className="mt-12" />
      {!primaryWallet && !verificationSent && (
        ...
        >
          <p className="text-[1.6rem] font-bold">Chomp at its full potential!</p>
          ...
          <div className="flex flex-col gap-4">
            <TextInput
                ...
                variant="primary"
            />
            <Button variant="purple" size="normal" className="gap-2 text-black font-medium" isFullWidth >
